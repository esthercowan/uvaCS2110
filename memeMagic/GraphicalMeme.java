...
/**
 * Graphical Meme This class extends the Meme class to provide Graphical functionality for Memes. It provides a
 * compileMeme function that takes a maximum dimension and produces an image of this Meme.
 * 
...
public class GraphicalMeme extends Meme {
    ...
    /**
     * Compile an image from this Meme. By default, this method produces an image that is no greater in size than 750x750
     * pixels.
     * 
    ...
    /**
     * Compile an image from this Meme with the given maximum size. It produces and image that is no greater than
